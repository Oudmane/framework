            ...
            return new Promise(function (resolve, reject) {
                ...
                trigger('beforeLoad', [_this2, route, _payload]).then(function () {
                    ...
                    return new Promise(function (resolve, reject) {
                        ...
                        if (!components) reject('Components unloaded');else if (!components[route.component]) reject('Component not found');else if (!components[route.component][route.task]) reject('task not found');else components[route.component][route.task].run(_this2, route, _payload).then(function (payload) {
            ...
            return new Promise(function (resolve) {
                ...
                _fs2.default.readdirSync(modulesDir).forEach(function (module) {
                    ...
                    if (_fs2.default.statSync(moduleDir).isDirectory()) {
                        var controllerFile = _path2.default.join(moduleDir, 'controller.js');
                        if (_fs2.default.existsSync(controllerFile)) modules[module] = require(controllerFile).default;
                    }
                });
                resolve(modules);
            });
