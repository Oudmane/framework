...
var objectKeys = function objectKeys(object, columns) {
    ...
    try {
        for (var _iterator = columns[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            ...
            if (_lodash2.default.get(object, key) === null) sObject[key] = _lodash2.default.get(object, key);else if (_lodash2.default.get(object, key).constructor.name === 'Object') sObject[key] = objectKeys(_lodash2.default.get(object, key));else if (_lodash2.default.get(object, key).constructor.name === 'Array') sObject[key] = _lodash2.default.get(object, key).map(function (element) {
                return element.valueOf();
            });else sObject[key] = _lodash2.default.get(object, key).valueOf();
        }
    } catch (err) {
    ...
    _createClass(Entity, [{
        ...
        value: function save() {
            ...
            return new Promise(function (resolve, reject) {
                ...
                var columns = isNew ? new Set(Object.keys(_this2.constructor.properties)) : _this2.getChanges();

                columns.delete('id');

                Array.from(columns).reduce(function (promise, key) {

                    if (typeof _lodash2.default.get(_this2, key).save === 'function') return promise.then(function () {
                        return new Promise(function (next) {
                            _lodash2.default.get(_this2, key).save().then(next);
                        });
                    });else if (_lodash2.default.get(_this2, key).constructor.name === 'Array') return promise.then(function () {
                        return _lodash2.default.get(_this2, key).reduce(function (promise, property) {
        ...
        value: function valueOf() {
            return this.id.toString() ? new _MongoDB2.default.ObjectID(this.id.toString()) : '';
        }
    }], [{
        key: 'load',
